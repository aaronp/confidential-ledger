...
import type { KeyPair, SerializedKeyPair } from "../../core/ledger.api";
import {
  generateKeyPair,
  serializeKeyPair,
  deserializeKeyPair,
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Create and manage keypair identities. Each identity has encrypted
          viewing access to their ledger entries.
        </CardDescription>
      </CardHeader>
        ...
        {currentIdentity && (
          <div className="text-xs text-muted-foreground pt-2 border-t">
            <p className="font-medium mb-1">
              Current Identity: {currentIdentity.id}
            </p>
            <p className="font-mono break-all">
              x25519 pub:{" "}
              {currentIdentity.x25519.publicKey.slice(0, 8).toString()}...
            </p>
          </div>
        )}
      </CardContent>
